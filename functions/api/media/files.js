...
function normalizeMimeType(value) {
  ...
  if (type === 'application/font-woff' || type === 'application/x-font-woff') return 'font/woff'
  if (type === 'application/font-woff2' || type === 'application/x-font-woff2') return 'font/woff2'
...
function folderLabel(mediaType) {
  ...
  if (mediaType === 'font') return 'Fonts'
  return 'Files'
}
...
function extensionForMime(mimeType = '', filename = '') {
  ...
  if (lower === 'font/woff2') return 'woff2'
  if (lower === 'font/woff') return 'woff'
...
function shouldRenderInline(contentType = '') {
  return contentType === 'application/pdf' || contentType.startsWith('image/') || contentType.startsWith('audio/') || contentType.startsWith('video/') || contentType.startsWith('text/') || contentType.startsWith('font/')
}
