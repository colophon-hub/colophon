...
function remoteOptions(fetcher, accept) { return { fetcher, accept, maxBytes: 2 * 1024 * 1024, timeoutMs: 9000, userAgent: 'ColophonMediaCampaignAutomation/1.0 (+https://example.invalid)' } }
