...
export async function onRequestGet(context) {
  ...
  const provider = String(context.env.colophon_DEPLOYMENT_PROVIDER || 'cloudflare-pages').trim()
  const target = String(context.env.colophon_DEPLOYMENT_DNS_TARGET || '').trim()
