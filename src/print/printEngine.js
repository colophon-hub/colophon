  ...
  render(post, request = {}) {
    ...
    return {
      ...
      colophon: options.showColophon
        ? ['Colophon Printlab', renderData.title, post.publishedDateLabel, post.slug].filter(Boolean).join(' / ')
        : '',
