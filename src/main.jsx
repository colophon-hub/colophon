...
import App from './App'
import { InvestigationRouteBoundary } from './components/InvestigationRouteBoundary'
...
import './admin-public-navigation.css'
...
import './adminClassicEditorReliability.js'
...
import './public-publication-theme.css'
...
if (browserLocal) {
  document.documentElement.dataset.colophonRuntime = 'browser-local'
...
ReactDOM.createRoot(document.getElementById('root')).render(
  <React.StrictMode>
    <Router>
      <InvestigationRouteBoundary><App /></InvestigationRouteBoundary>
