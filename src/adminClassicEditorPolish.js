...
function setDistractionFree(enabled) {
  document.body.classList.toggle('is-colophon-distraction-free', enabled)
...
function toggleDistractionFree() {
  setDistractionFree(!document.body.classList.contains('is-colophon-distraction-free'))
}
...
function handleKeydown(event) {
  if (!isEditorRoute()) return
  if (event.key === 'Escape' && document.body.classList.contains('is-colophon-distraction-free')) {
