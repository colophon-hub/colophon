...
function isMediaPost() {
  return document.body.classList.contains('is-colophon-preview-media') || /\b(zine|comic|comics|reader|manifesto|print|colophoneurs)\b/i.test(decodeURIComponent(window.location.pathname || ''))
}
