...
const CONTACT_CHANNELS = [
  ...
  { label: 'Submissions and pitches', address: 'submit@example.org' },
...
function ContactChannels() {
  return (
    <div className="contact-channels">
      ...
      <div className="contact-channel-grid" aria-label="Other Colophon contact addresses">
  ...
  return (
    <section className="project-directory" aria-labelledby="project-directory-title">
      <header className="project-directory__header">
        ...
        <p>
          Colophon is one archive made from distinct publishing projects. Each project has its own identity,
