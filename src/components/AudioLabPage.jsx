    ...
    <AdminFrame>
      <main className="page wp-admin-screen audio-lab-page">
        <div className="wp-screen-header audio-lab-header">
          <div><p className="audio-lab-eyebrow">Native Colophon audio desk</p><h1>AudioLab</h1><p className="description">AudioLab v1 stabilized: local editing, rendered master, public delivery audio, podcast drafts, and RSS-ready metadata.</p></div>
