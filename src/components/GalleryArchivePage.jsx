...
const GALLERY_SLUG = 'Exampletown-local-1312'
  ...
  return (
    <main className="page public-search-page archive-page publication-gallery-page">
      ...
      <section className="project-hero archive-page__hero publication-gallery-hero">
        <EditableText as="p" className="project-hero__eyebrow" field="gallery.Exampletown-local-1312.hero.eyebrow">archive / photography / Exampletown Local 1312</EditableText>
        <EditableText as="h1" field="gallery.Exampletown-local-1312.hero.title">{gallery?.title || 'Exampletown Local 1312 Gallery'}</EditableText>
        <EditableText as="p" className="project-hero__description" field="gallery.Exampletown-local-1312.hero.description" multiline>
          {gallery?.description || 'Historical image archive from Exampletown Local 1312, preserved from the original Colophon Noblogs site.'}
        </EditableText>
        <div className="project-hero__meta publication-gallery-hero__meta">
          ...
          <EditableLink labelField="gallery.Exampletown-local-1312.actions.archive.label" hrefField="gallery.Exampletown-local-1312.actions.archive.href" defaultLabel="Browse full archive" defaultHref="/archive" />
        </div>
      </section>

      {state === 'loading' ? (
        <section className="archive-results publication-gallery-state"><EditableText as="h2" field="gallery.state.loading.title">Loading gallery</EditableText><EditableText as="p" field="gallery.state.loading.body">Reading the preserved gallery from Colophon storage.</EditableText></section>
      ) : null}
      ...
      {items.length ? (
        <section className="archive-results publication-gallery-results" aria-label={gallery?.title || 'Exampletown Local 1312 Gallery'}>
