      ...
      <main className="page wp-admin-screen feeds-admin-page">
        <div className="wp-screen-header">
          <div>
            ...
            <p className="description">Manage site-wide RSS discovery, taxonomy feeds, aliases, privacy-safe public labels, and the public feed directory. Podcast show identity and imports live in Podcasts; this page discovers and publishes those show feeds alongside the rest of Colophon's syndication endpoints.</p>
          </div>
        ...
        <section className="wp-meta-box">
          ...
          <div className="wp-list-table-wrap">
            <table className="content-table wp-posts-table">
              <thead><tr><th>Show</th><th>Episodes</th><th>Source RSS</th><th>Colophon RSS</th><th>Last synced</th><th>Actions</th></tr></thead>
              <tbody>
