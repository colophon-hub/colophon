      ...
      {isPress ? (
        <section className="public-press-kit">
          <article className="wp-meta-box">
            <EditableText as="h2" field="surface.press.about.title">Colophon</EditableText>
            <EditableText as="p" field="surface.press.about.body" multiline>
              Colophon is an independent public-interest media project publishing reporting, essays,
