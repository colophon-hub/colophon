    ...
    <section className={`wp-meta-box desktop-publish-card${requested ? ' is-highlighted' : ''}`}>
      ...
      <div className="desktop-publish-card__options">
        <article>
          ...
          <p>Use a free hosting tier and its provided address. Colophon currently documents Cloudflare Pages as the supported no-cost production route. You can add your own domain later.</p>
        ...
        <article>
          ...
          <p>Keep the hosting free and attach the domain you already pay for. Colophon shows the exact DNS target supplied by the host instead of assuming one provider.</p>
        ...
        <article>
          ...
          <p>A compatible host can run Colophon for you. This is the closest model to Noblogs: somebody else handles the server while you just publish.</p>
      ...
      <p className="description"><strong>Cost rule:</strong> Colophon should always offer a $0 route to a public site where a supported free host is available. Buying a custom domain is optional.</p>
    </section>
  )
}
