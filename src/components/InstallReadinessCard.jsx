  ...
  return (
    <section className="wp-meta-box install-readiness-card">
      ...
      <ul className="install-readiness-card__list">
        <ReadinessRow ready={appReady} title="Colophon is running" detail={appReady ? 'The application responded normally.' : 'The application health check has not completed.'} />
