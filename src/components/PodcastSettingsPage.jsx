      ...
      <main className="page wp-admin-screen">
        <div className="wp-screen-header">
          <div>
            ...
            <p className="description">A podcast is a show-level container. Its RSS source, metadata, imported episodes, and outgoing Colophon RSS feed stay separate from every other podcast.</p>
          </div>
        ...
        <section className="wp-meta-box">
          ...
          <p className="description">Paste this show's current RSS feed. On a new podcast, the first import creates the show and gives it its own Colophon RSS URL. On an existing podcast, imports and resyncs remain scoped to this show only.</p>
        ...
        <section className="wp-meta-box">
          ...
          <div className="wp-settings-form">
            <label>
              <span>Canonical Colophon RSS feed URL</span>
        ...
        <section className="wp-meta-box">
          ...
          <div className="wp-settings-form">
            ...
            <label><span>Audio host URL/base</span><input type="url" value={settings.audioHostBaseUrl} onChange={(e) => update('audioHostBaseUrl', e.target.value)} placeholder="https://media.example.org/podcasts/" /></label>
