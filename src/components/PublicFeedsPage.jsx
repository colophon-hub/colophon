...
function groupDescription(group) {
  const descriptions = {
    'all-content.xml': 'The broad live feed for published server-backed content.',
  ...
  return (
    <main className="page feeds-public-page">
      ...
      <section className="public-info-page__hero">
        ...
        <EditableText as="h1" field="feeds.hero.title">{settings.feedsIntroTitle || 'Follow this publication'}</EditableText>
      ...
      <section className="feeds-public-page__panel">
        ...
        <EditableText as="div" field="feeds.how.body" multiline>{`These are live RSS endpoints backed by the publication's persisted feed configuration. A reader can subscribe with an RSS reader or compatible app, an archivist can mirror them, and another site can syndicate them.
...
Older imported archive pieces remain browseable in the publication and enter live website feeds as they are migrated into native server-backed content.`}</EditableText>
      </section>
...
Editors can rename or hide bad imported labels in the backend, and the same persisted rules are applied by the live website-content XML endpoints.`}</EditableText>
      ...
      <section className="feeds-public-page__panel">
        ...
        <EditableText as="p" field="feeds.why.body" multiline>Feeds make a publication easier to follow, mirror, cite, preserve, and rebuild. If the homepage changes, the archive still has structure. If social platforms bury a post, the feed still publishes it.</EditableText>
