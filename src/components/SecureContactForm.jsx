...
const PUBLIC_KEY_URL = '/keys/info-colophon-media.asc'
    ...
    async function loadPublicKey() {
      try {
        ...
        if (fingerprint !== EXPECTED_FINGERPRINT || !identityMatches) {
          throw new Error('The public key did not match the pinned Colophon identity.')
        }
  ...
  return (
    <section className="secure-contact" aria-labelledby="secure-contact-title">
      ...
      <p className="secure-contact__intro">
        This form encrypts your message in this browser for <strong></strong>, then opens your email app. Nothing is uploaded to Colophon by the form itself.
      </p>
