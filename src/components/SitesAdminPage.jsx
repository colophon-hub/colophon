    ...
    <AdminFrame>
      <main className="page wp-admin-screen wp-sites-screen">
        <div className="wp-screen-header">
          <div><h1>Domain setup</h1><p className="description">Add the public address you want. Colophon will show the DNS record your current host expects.</p></div>
