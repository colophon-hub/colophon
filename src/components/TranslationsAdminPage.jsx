...
const DEFAULT_WEBLATE_URL = 'https://hosted.weblate.org/projects/colophon/ai-server-called-paranoia/'
    ...
    <AdminFrame>
      <main className="page wp-admin-screen translations-admin-page">
        <div className="wp-screen-header">
          <div>
            <h1>Translations</h1>
            <p className="description">Weblate is the collaboration workspace. Colophon remains the publication authority: import finished language files here, review them, and explicitly publish them to the article language selector.</p>
          </div>
        ...
        <section className="wp-meta-box">
          <div className="wp-screen-header">
            <div><h2>Existing translations hosted elsewhere</h2><p className="description">Keep community translations on the translator's original site unless they explicitly want their work moved into Weblate under this project's translation license. Colophon can register the original URL and credit without republishing the text.</p></div>
