    ...
    <AdminFrame>
      <main className="page wp-admin-screen admin-users-page">
        ...
        <section className="wp-meta-box">
          ...
          <p className="description">Colophon currently provisions accounts directly. It does not pretend to send invitation email without a mail service. Give the person their temporary password through a separate secure channel.</p>
        ...
        <section className="wp-meta-box">
          ...
          <p className="description">The emergency <code>colophon_ADMIN_TOKEN</code> remains a bootstrap Owner path so a broken user record cannot permanently lock the site. It should not be shared as a normal login.</p>
        </section>
      </main>
    </AdminFrame>
  )
