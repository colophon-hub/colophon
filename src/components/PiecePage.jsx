...
const MODE_STORAGE_KEY = 'colophon.postMode'
...
export function PiecePage({ pieces = [] }) {
  ...
  const headerMetaItems = useMemo(() => {
    if (!piece) return []
    return [piece.isPreviewSnapshot ? 'Preview' : categoryLabel, 'Colophon', formatMetaType(piece.type), piece.publishedDateLabel]
