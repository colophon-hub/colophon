  ...
  return (
    <main className="page collections-page">
      ...
      <section className="collections-hero">
        ...
        <EditableText as="p" field="collections.index.description" multiline>Browse Colophon collections by project, timeline, downloads, gallery, and related reading.</EditableText>
      </section>
