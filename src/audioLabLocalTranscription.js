...
async function runLocalTranscription(shell, button, textarea) {
  ...
  setStatus(shell, `Loading audio for local ${TRANSCRIPT_MODEL_OPTIONS[quality].label}. No local transcription. No Cloudflare AI. Just your browser doing unpaid speech labor.`)
