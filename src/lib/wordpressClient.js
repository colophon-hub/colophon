...
function inferType(post, categories = [], tags = []) {
  ...
  if (/podcast|Example Podcast|youtube|spotify|soundcloud|acast|peertube/.test(haystack)) return 'podcast'
  if (/zine|comic|print|booklet|pdf|distro|colophonuers|Example Project/.test(haystack)) return 'print'
