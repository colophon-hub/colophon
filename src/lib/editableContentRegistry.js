export const editableContentRegistry = {
  ...
  archive: {
    ...
    body: {
      ...
      defaultText:
        'Search and filter the full Colophon archive by project, format, and keyword.',
    },
    countLabel: {
...
`,
    ...
    actions: [
      { id: 'pgp', labelField: 'info.security.actions.pgp.label', hrefField: 'info.security.actions.pgp.href', defaultLabel: 'Download PGP key', defaultHref: '/keys/info-colophon-media.asc' },
