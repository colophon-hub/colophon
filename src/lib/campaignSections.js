export const CAMPAIGN_SECTION_DEFINITIONS = [
  ...
  { key: 'reporting', label: 'Reporting + context', nav: 'Reporting', title: 'Reporting and context', description: 'Colophon reporting and contextual resources connected to this campaign.', editor: 'resources' },
