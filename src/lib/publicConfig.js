...
import { genericPublicDefaults } from '../content/genericPublicDefaults'
import { mergePublicConfig as mergeSchemaConfigs, normalizePublicConfig } from './publicConfigSchema'

const STORAGE_KEY = 'colophon-public-site-config-v1'
...
export function resolvePublicConfig(runtimeConfig = {}) {
  const genericBase = mergeSchemaConfigs(publicSiteDefaults, genericPublicDefaults)
  return mergeSchemaConfigs(genericBase, runtimeConfig || {})
}
