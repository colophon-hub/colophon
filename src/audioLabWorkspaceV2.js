const ACTIVE_TAB_KEY = 'colophon:audiolab:inspector-tab:v4'
let observer = null
...
window.addEventListener('colophon:audiolab-inspector-changed', queueRefresh)
window.addEventListener('colophon:audiolab-project-updated', queueRefresh)
