...
Colophon keeps WordPress/Noblogs import as a migration path instead of requiring editors to rebuild an archive by hand.

Export the old site as WordPress WXR/XML, keep an untouched copy of that export, and run the repository importer against it. Imported publication content is instance data and should not be committed to the Colophon software repository.
