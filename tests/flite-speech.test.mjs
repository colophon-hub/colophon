...
import {
  colophon_FLITE_VOICE,
  FLITE_ASSET_PATHS,
  decodeWavePcm,
  normalizeFliteSpeechOptions,
} from '../src/accessibility/fliteSpeechEngine.js'
import { colophon_SPEECH_ENGINE, colophon_SPEECH_VOICE } from '../src/accessibility/colophonSpeechEngine.js'
...
test('Colophon speech defaults to the exact Flite cmu_us_lnh voice', () => {
  assert.equal(colophon_SPEECH_ENGINE, 'flite')
  assert.equal(colophon_FLITE_VOICE, 'cmu_us_lnh')
  assert.equal(colophon_SPEECH_VOICE, 'cmu_us_lnh')
