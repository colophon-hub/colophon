...
function normalizePiece(item, attachmentMap) {
  ...
  return {
    ...
    title,
    slug,
    author: cleanText(item.creator) || 'colophon-hub',
...
function normalizeProjectName(name) {
  ...
  const map = {
    ...
    'the communique': 'Example Newsletter',
    'Example Podcast': 'Example Project',
    'Example Podcast': 'Example Project',
    'Example Print Project': 'Example Print Project',
    'Example Comics': 'Example Comics',
    'zines and comics': 'Zines and Comics',
    'general': 'General',
    'Example Project': 'Example Project',
    'get to know your neighborhood': 'Get To Know Your Neighborhood',
    'colophons bay': 'colophons Bay',
...
function inferType(categories, relatedAssets, bodyHtml) {
  ...
  if (/youtube|soundcloud|acast|spotify|peertube/.test(joined) || joined.includes('podcast') || joined.includes('Example Podcast')) return 'podcast'
  if (joined.includes('comic') || joined.includes('colophonuers') || joined.includes('Example Project')) return 'comic'
  if (joined.includes('zine') || joined.includes('Example Print Project') || relatedAssets.some((asset) => /\.pdf($|\?)/i.test(asset.url))) return 'zine'
  return 'article'
}
